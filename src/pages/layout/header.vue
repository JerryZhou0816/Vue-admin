<template>
  <header
    class="main-header animated"
    :class="{ closeLogo: sidebar.collapsed, mobileLogo: device.isMobile }"
  >
    <a href="#" class="logo">
      <span class="logo-lg"
        ><i class="fa fa-diamond"></i>&nbsp; <b>XMall商品管理</b></span
      >
    </a>
    <nav class="navbar">
      <a
          ...
          <el-dropdown-menu>
            <ul class="message-list">
              <li v-for="(item, index) in list">
                <!-- start message -->
                <router-link
                  :to="{ path: '/sys/message', query: { id: item.id } }"
                >
