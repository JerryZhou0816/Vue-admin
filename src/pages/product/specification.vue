  ...
  <div>
    ...
    >
      <el-form-item label="属性名称">
        <el-input v-model="formInline.user" placeholder="属性名称"></el-input>
      </el-form-item>
      <el-form-item>
    ...
    <el-table style="width: 100%; margin: 20px 0" border>
      <el-table-column align="center" prop="prop" label="序号" width="width">
      </el-table-column>
      <el-table-column align="center" prop="prop" label="属性ID" width="width">
      </el-table-column>
      <el-table-column
        align="center"
        prop="prop"
      ...
      <el-table-column align="center" prop="prop" label="属性值" width="width">
      </el-table-column>
    ...
    <el-dialog title="新增" :visible.sync="isShowDialog">
      <el-table border style="width: 100%" :data="defaultList">
